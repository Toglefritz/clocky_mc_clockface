...
import 'meridiem_indicator.dart';
...
class Clock extends StatelessWidget {
  ...
  /// The style of clock face to use for this widget, either analog or digital.
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      '$hours:${minutes.toZeroPaddedString()}:${seconds.toZeroPaddedString()}',
                ...
                Positioned(
                  top: 8,
                  right: 8,
                  child: MeridiemIndicator(
                    meridiem: controller.meridiem,
                  ),
                ),
              ],
            );
          ...
          // Analog clock
            ...
            return Stack(
              children: [
                ...
                Positioned(
                  top: ((MediaQuery.of(context).size.height - 350) / 2) - sqrt(350 ^ 2 + 350 ^ 2) - 50,
